...
export function StudentDashboard() {
  ...
  const supervisorInviteStatus = pendingApplication?.supervisor_approval_status || activeInternship?.supervisor_approval_status || (activeInternship?.industry_supervisor?.user?.id ? "approved" : null) || "pending";
