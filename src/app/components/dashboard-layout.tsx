...
const cloNav: NavItem[] = [
  ...
  { to: "/clo/attendance", icon: MapPin, label: "Attendance" },
...
const dloNav: NavItem[] = [
  ...
  { to: "/dlo/attendance", icon: MapPin, label: "Attendance" },
...
const academicNav: NavItem[] = [
  ...
  { to: "/academic/attendance", icon: TrendingUp, label: "Attendance" },
  { to: "/academic/grades", icon: Award, label: "Grades" },
