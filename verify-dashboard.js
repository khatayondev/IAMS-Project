...
(async () => {
  ...
  try {
    ...
    // Test navigation to logbook
    console.log('\n=== TESTING LOGBOOK NAVIGATION ===');
    await page.click('text=Logbook');
    await page.waitForTimeout(2000);
    
    const logbookErrors = errors.filter(e => e.includes('logbook') || e.includes('Logbook'));
    if (logbookErrors.length === 0) {
      console.log('✅ Logbook page navigated without errors');
    }
